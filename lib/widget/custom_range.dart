...
class CustomRange extends StatefulWidget {
  const CustomRange({Key key, this.values, this.onChangeRangeValues,this.activeColor})
      : super(key: key);
        ...
        children: <Widget>[
          ...
          SliderTheme(
            ...
            child: RangeSlider(
              ...
              min: 0.0,
              max: 1000.0,
              activeColor: widget.activeColor!= null ? widget.activeColor : Color(0xff4FA760),
